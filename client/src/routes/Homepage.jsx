...
const Homepage = () => {
  ...
  return (
    <div className="flex flex-col gap-12 md:gap-26 !pt-0">
      {/* INTRO */}
      <div className="container-full mt-6 md:mt-10 pt-[var(--navbar-height)] px-4 pb-4 text-white md:px-6">
        <div className="relative flex flex-col justify-start mx-auto h-full rounded-2xl text-center md:justify-between">
                  ...
                  <div className="flex flex-col items-center space-y-4 px-4 pt-12 pb-8">
                    ...
                    <div className="flex space-x-6">
                      ...
                      <a 
                        ...
                        className="group flex items-center justify-center bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-xl px-4 py-3 transition-all duration-300 hover:scale-105 border border-white/20"
                      >
                        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                        </svg>
                        <span className="text-white font-medium hidden sm:inline ml-2">LinkedIn</span>
                      </a>
                      ...
                      >
                        ...
                        <span className="text-white font-medium hidden sm:inline ml-2">GitHub</span>
                      </a>
                      ...
                      >
                        ...
                        <span className="text-white font-medium hidden sm:inline ml-2">Email</span>
                      </a>
                    </div>
                  </div>
                  {/* ANIMATED BUTTON */}
      ...
      <FeaturedPosts />
      {/* POST LIST */}
      <div className="flex flex-col mx-auto px-4 md:px-8 lg:px-16 xl:px-20 2xl:px-32">
        {/* Recent Posts Title */}
