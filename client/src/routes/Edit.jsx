...
const Edit = () => {
  ...
  return (
    <div className="px-4 md:px-8 lg:px-16 xl:px-28 2xl:px-32">
      <div className='min-h-[calc(100vh-64px)] md:min-h-[calc(100vh-80px)] flex flex-col gap-6 bg-white rounded-2xl shadow-lg p-8 mt-[calc(var(--navbar-height)+32px)]'>
